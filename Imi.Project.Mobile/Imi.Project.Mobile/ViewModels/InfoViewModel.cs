...
namespace Imi.Project.Mobile.ViewModels
{
    public class InfoViewModel : FreshBasePageModel
    {
        ...
        public InfoViewModel(IApiAnimalRepository animalService)
        {
        ...
        public ICommand OpenEditPageCommand => new Command<CreateEditDto>(
            async (CreateEditDto animal) => { await CoreMethods.PushPageModel<EditViewModel>(animal, false, false); });
    }
}
